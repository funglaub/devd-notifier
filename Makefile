...
man: devd-notifier.1.in
	@sed -e "s/VERSION/${VERSION}/g" < devd-notifier.1.in > devd-notifier.1

clean:
	@echo cleaning
	@rm -f devd-notifier ${OBJ} devd-notifier.1
...
install: all
	...
	@echo install manual page to ${DESTDIR}${MANPREFIX}/man1/devd-notifier.1
	@mkdir -p ${DESTDIR}${MANPREFIX}/man1
	@chmod 0755 ${DESTDIR}${MANPREFIX}/man1
	@install -m 0644 devd-notifier.1 ${DESTDIR}${MANPREFIX}/man1/
